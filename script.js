...
const cardMidi = document.querySelector(".card-midi");
cardMidi.style.display = "none";
const cardSoir = document.querySelector(".card-soir");
cardSoir.style.display = "none";
const cardWeekEnd = document.querySelector(".card-week-end");
cardWeekEnd.style.display = "none";

const title = document.querySelector("h1");
const titleRandom = document.querySelector("h2")
const randomCard = document.querySelector(".card-random")
...
const displayMenu = function (e) {
  ...
  if (e.target.className === "nav-link midi") {
    cardMidi.style.display = "block";
  } else {
    cardMidi.style.display = "none";
  }
  if (e.target.className === "nav-link soir") {
    cardSoir.style.display = "block";
  } else {
    cardSoir.style.display = "none";
  }
  if (e.target.className === "nav-link week-end") {
    cardWeekEnd.style.display = "block";
  } else {
    cardWeekEnd.style.display = "none";
  }
};
...
titleRandom.addEventListener('click', (e) => {
...
popUp.addEventListener('mouseleave', e => {
    ...
    if (e.pageY - window.scrollY <= 0) {
       ...
       cardModal.innerText = 'Pars pas comme ca, laisse ton mail !'
       titleRandom.style.display = "none";
       randomCard.style.display = "none";
       title.style.display = "none";
    }
    body.addEventListener('click',() =>{
        cardModal.style.display = 'none'
        // title.style.display = "block";
        titleRandom.style.display = "block";
    })
 });
